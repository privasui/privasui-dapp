...
import { PinsNftSell } from './pins-nft-sell';
import { X } from 'lucide-react';
import { cn } from "@/shared/utils";

interface PinsNftSellDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  nft: any;
  onSuccess?: () => void;
...
export const PinsNftSellDrawer: React.FC<PinsNftSellDrawerProps> = ({
  isOpen,
  onClose,
  nft,
  onSuccess
  ...
  const handleCloseClick = () => {
    console.log("🔴 Close button clicked in PinsNftSellDrawer, closing drawer");
